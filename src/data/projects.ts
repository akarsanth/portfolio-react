...
export default [
  {
    ...
    techs: [
      ...
      { name: "Express.js", short: "express" },
      { name: "Node.js", short: "node" },
      { name: "Formik", short: "formik" },
      { name: "Yup", short: "yup" },
      { name: "Axios", short: "axios" },
      { name: "JWT", short: "jwt" },
      { name: "MySQL", short: "mysql" },
      { name: "Sequelize", short: "sequelize" },
      { name: "Bcrypt.js", short: "bcrypt" },
    ],
  },
  {
    _id: 2,
    ...
    techs: [
      { name: "React", short: "react" },
      { name: "TypeScript", short: "typescript" },
      { name: "Framer", short: "framer" },
      { name: "Sass", short: "sass" },
    ],
  },
];
